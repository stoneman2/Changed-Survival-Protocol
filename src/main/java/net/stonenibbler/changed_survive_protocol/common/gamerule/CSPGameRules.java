...
public final class CSPGameRules {
    ...
    public static final GameRules.Key<GameRules.IntegerValue> LATEX_HEART_GROWTH_INTERVAL = GameRules.register("csp:latexHeartGrowthInterval", GameRules.Category.UPDATES, GameRules.IntegerValue.create(50));
    ...
    public static final GameRules.Key<GameRules.IntegerValue> LATEX_HEART_DECAY_INTERVAL = GameRules.register("csp:latexHeartDecayInterval", GameRules.Category.UPDATES, GameRules.IntegerValue.create(25));
