...
public final class CSPGameRules {
    ...
    public static final GameRules.Key<GameRules.IntegerValue> LATEX_HEART_NEW_CHUNK_CHANCE = GameRules.register("csp:latexHeartNewChunkChance", GameRules.Category.UPDATES, GameRules.IntegerValue.create(600));
    ...
    public static final GameRules.Key<GameRules.IntegerValue> LATEX_HEART_GROWTH_INTERVAL = GameRules.register("csp:latexHeartGrowthInterval", GameRules.Category.UPDATES, GameRules.IntegerValue.create(75));
    public static final GameRules.Key<GameRules.IntegerValue> LATEX_HEART_MAX_CLAIMS = GameRules.register("csp:latexHeartMaxClaims", GameRules.Category.UPDATES, GameRules.IntegerValue.create(75000));
    public static final GameRules.Key<GameRules.IntegerValue> LATEX_HEART_MAX_ACTIVE_PER_DIMENSION = GameRules.register("csp:latexHeartMaxActivePerDimension", GameRules.Category.UPDATES, GameRules.IntegerValue.create(128));
    ...
    public static final GameRules.Key<GameRules.IntegerValue> LATEX_HEART_DECAY_INTERVAL = GameRules.register("csp:latexHeartDecayInterval", GameRules.Category.UPDATES, GameRules.IntegerValue.create(75));
    public static final GameRules.Key<GameRules.IntegerValue> LATEX_HEART_MOB_SPAWN_INTERVAL = GameRules.register("csp:latexHeartMobSpawnInterval", GameRules.Category.MOBS, GameRules.IntegerValue.create(600));
